...
/**
 * This class stores the email id of the student renting a locker.
 */
public class Email {
    ...
    /**
     * This function snstantiates the email id of a student.
    ...
    /**
     * This function checks if the email-id is valid or not.
