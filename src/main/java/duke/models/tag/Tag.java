...
/**
 * This class stores the status of a locker.
 */
public class Tag {
    ...
    /**
     * This function instantiates the status of the locker that it is associated with.
    ...
    /**
     * This function checks if the tag name is valid or not i.e whether it is in-use, not-in-use, available
     * or broken.
